...
\begin{document}
	...
	\begin{eqnarray}
	 (\lambda z.z)(\lambda z.zz)(\lambda z.z y) &\rightarrow_\beta&  (\lambda z.zz)(\lambda z.z y)\\
	  &\rightarrow_\beta&  (\lambda z.z y)(\lambda z.z y)\\	  
	  &\rightarrow_\beta&  (\lambda z.z y)y\\
	  &\rightarrow_\beta&  yy
	\end{eqnarray}
	...
	((  (\lambda x.\lambda y.(x y)) (\lambda y.y) )w) &\rightarrow_\beta&  
    (  \lambda y.(x y))w \\
	&\rightarrow_\beta&  xw
	\end{eqnarray}
	...
	{\em Solution}: $\overline{fib}$ $\overline{n} =_\beta \overline{f(n)}$.
	...
	=(\lambda z. \lambda y. (zy) \overline{n}) \overline{2}
	=(\lambda z. \lambda y. (zy) \lambda f x. f^n x) \lambda f.\lambda x.(f (f x))
	$
